			...
			<div class="col-xs-12">
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="<?php echo U('Admin/System/pptH');?>" method="post" class="form-horizontal" enctype="multipart/form-data" />
							<input name="id" type="hidden" value="<?php echo ($ppt["0"]["pp_id"]); ?>" />
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<div style="border: 1px solid #999999;min-height: 100px;text-align: center;padding: 2px;">
										<img src="<?php echo ($ppt["0"]["pp_img"]); ?>" />
									</div>
								</div>
							</div>
							
							<div class="form-group">
                                <label class="col-sm-3 col-md-3 col-lg-1 control-label">幻灯1</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="row">
                                    	<div class="col-md-6">
                                        	<input type="text" value="<?php echo ($ppt["0"]["pp_img"]); ?>" class="form-control" readonly />
                                        </div>
                                       	<div class="col-md-6">
                                        	<input type="text" placeholder="指向文章或者url" class="form-control" name="url"/>
                                        </div>
                                   </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                           		<label class="col-sm-3 col-md-3 col-lg-1 control-label">幻灯1修改</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
						...
						<form action="<?php echo U('Admin/System/pptH');?>" method="post" class="form-horizontal" enctype="multipart/form-data" />
							<input name="id" type="hidden" value="<?php echo ($ppt["1"]["pp_id"]); ?>" />
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-1 control-label">预览</label>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<div style="border: 1px solid #999999;min-height: 100px;text-align: center;padding: 2px;">
										<img src="<?php echo ($ppt["1"]["pp_img"]); ?>" />
									</div>
								</div>
							</div>
							
							<div class="form-group">
                                <label class="col-sm-3 col-md-3 col-lg-1 control-label">幻灯2</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="row">
                                    	<div class="col-md-6">
                                        	<input type="text" value="<?php echo ($ppt["1"]["pp_img"]); ?>" class="form-control" readonly />
                                        </div>
                                       	<div class="col-md-6">
                                        	<input type="text" placeholder="指向文章或者url" class="form-control" name="url"/>
                                        </div>
                            ...
                            <div class="form-group">
                           		<label class="col-sm-3 col-md-3 col-lg-1 control-label">幻灯2修改</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	<input type="file" name="file" />
                                    </div>
						...
						<form action="<?php echo U('Admin/System/pptH');?>" method="post" class="form-horizontal" enctype="multipart/form-data" />
							<input name="id" type="hidden" value="<?php echo ($ppt["2"]["pp_id"]); ?>" />
							<div class="form-group">
								<label class="col-sm-3 col-md-3 col-lg-1 control-label">预览</label>
								<div class="col-sm-9 col-md-9 col-lg-10">
									<div style="border: 1px solid #999999;min-height: 100px;text-align: center;padding: 2px;">
										<img src="<?php echo ($ppt["2"]["pp_img"]); ?>" />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="row">
                                    	<div class="col-md-6">
                                        	<input type="text" value="<?php echo ($ppt["2"]["pp_img"]); ?>" class="form-control" readonly />
                                        </div>
                                       	<div class="col-md-6">
                                        	<input type="text" placeholder="指向文章或者url" class="form-control" name="url"/>
                                        </div>
