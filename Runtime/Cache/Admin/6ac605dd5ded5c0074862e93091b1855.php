...
<head>
    ...
    <title>后台登录</title>
    <style type="text/css">
    #cloud1, #cloud2{position:absolute; top:100px; left:0px; width:405px; height:165px; z-index:6; opacity:0.5; background:url(/Public/Img/login_cloud.jpg) no-repeat;}
    #cloud2{z-index:7; top:200px;}
    </style>
...
<div style="position: fixed;bottom: 20px;text-align: center;width: 100%;">
    Copyright ©2015 http://www.weiloving.com
</div>
</body>
<script type="text/javascript">
        // Cloud Float...
    ...
    setInterval(function flutter(){
        ...
        offset1 += 1.1;
        offset2 += 1;
        $cloud1.css("left", offset1);
        $cloud2.css("left", offset2);
    }, 70);
</script>
</html>