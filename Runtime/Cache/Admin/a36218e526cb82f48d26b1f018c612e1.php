					...
					<div class="col-xs-12">
						<div class="widget-box">
							<div class="widget-title">
								...
								<?php else: ?>
									<h5>修改栏目</h5>
									<input id="id" value="<?php echo ($info["t_id"]); ?>" type="hidden"/><?php endif; ?>
							</div>
								...
								<form action="#" method="get" class="form-horizontal">
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="row">
                                        		<div class="col-md-6">
                                            		<input type="datetime" <?php if(empty($info['t_id'])): ?>value="<?php echo date("Y-m-d H:i:s",time());?>"<?php else: ?>value="<?php echo (date('Y-m-d H:i:s',$info["t_time"])); ?>"<?php endif; ?> class="form-control input-sm"  id="time"/>
                                            	</div>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" <?php if(empty($info['t_id'])): ?>value="<?php echo (session('uname')); ?>"<?php else: ?>value="<?php echo ($info["t_root"]); ?>"<?php endif; ?> class="form-control input-sm" id="root"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" <?php if(empty($info['t_id'])): ?>value="<?php echo (C("SORT")); ?>"<?php else: ?>value="<?php echo ($info["t_sort"]); ?>"<?php endif; ?> class="form-control input-sm" id="sort"/>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
												<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            	<input type="text" <?php if(empty($info['t_id'])): ?>value="<?php echo getOs();?>"<?php else: ?>value="<?php echo ($info["t_from"]); ?>"<?php endif; ?> class="form-control input-sm" id="from" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
												<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            	<input type="text" <?php if(empty($info['t_id'])): ?>value="<?php echo get_client_ip();?>"<?php else: ?>value="<?php echo ($info["t_ip"]); ?>"<?php endif; ?> class="form-control input-sm" id="ip" />
                                            </div>
                                        </div>
                                    </div>
            	...
            	$(document).ready(function(){
				    ...
				    $('#edittag').click(function(){
				    	...
				    	$.ajax({
				    		...
				    		async:true,
				    		data:{"t_id":id,"t_name":name,"t_time":time,"t_sort":sort,"t_view":show,"t_remark":remark,"t_ip":ip,"t_from":from,"t_root":root},
				    		success:function(data){
				    			if(data.error==0){
									succ("修改栏目完成!",data.msg,"/Admin/Tag/tagList");
								}else{
									err(data.msg);
