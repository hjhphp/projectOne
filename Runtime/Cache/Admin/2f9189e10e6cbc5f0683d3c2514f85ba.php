                    ...
                    <div class="widget-content nopadding">
                        <form action="#" method="get" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-md-3 col-lg-1 control-label">头条名</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-addon"><i class="fa fa-tags"></i></span>
                                        <input type="text" value="" class="form-control input-sm" placeholder="头条名" id="name" />
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 col-md-3 col-lg-1 control-label">头条描述</label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                            ...
                            <div class="form-actions">
                                <button type="button" class="btn btn-success btn-sm" id="addtag">存入数据库</button>
...
<script>
    $(document).ready(function(){
        ...
        $('#addtag').click(function(){
            ...
            $.ajax({
                type:"post",
                url:"/Admin/Topline/topAdd",
                async:true,
                data:{"top_name":name,"createtime":time,"sort":sort,"is_show":show,"top_content":remark,"top_user":root},
                success:function(data){
                    if(data.error==0){
                        succ("添加栏目完成!",data.msg,"/Admin/Topline/Toplist");
                    }else{
                        err(data.msg);
        ...
        $('#edittag').click(function(){
            ...
            $.ajax({
                type:"post",
                url:"/Admin/Top/topEditH",
                async:true,
                data:{"top_name":name,"createtime":time,"sort":sort,"is_show":show,"top_content":remark,"top_user":root},
                success:function(data){
                    if(data.error==0){
                        succ("修改栏目完成!",data.msg,"/Admin/Topline/topList");
                    }else{
                        err(data.msg);
