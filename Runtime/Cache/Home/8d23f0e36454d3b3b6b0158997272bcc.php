		...
		<div class="row aerousel">
			...
			<div class="col-md-8 row-l about-all">
				...
				<div class="about">
					...
					<p><strong>姓名</strong>：金浩</p>
					<p><strong>网名</strong>：飞鱼飞鸟一起来</p>
					...
					<p><strong>喜欢的话</strong>：人活着就是为了生存，而生存易生活难，每每很多问题困扰我的时候，我总是想着自己的网名：<a>飞鱼飞鸟一起来</a>，然后让自己开开心心的过每一天，把不开心的事都一一过滤。每一天都有计划和学习，那样的日子才是最好的，不是么？</p>					
				</div>
				<div class="about-love">
					<h4>关于程序</h4><hr>
					<p><strong>原由</strong>：...</p>
					<p><strong>域名</strong>：<?php echo (C("SITE_URL")); ?></p>
					<p><strong>创建时间</strong>：<?php echo ($system["createtime"]); ?></p>
					<p><strong>评价</strong> ：<a href="http://koubei.baidu.com/w/weiloving.com" target="_blank">邀你点评</a></p>
