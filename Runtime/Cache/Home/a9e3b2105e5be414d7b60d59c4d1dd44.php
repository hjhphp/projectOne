        ...
        <div class="col-md-8 row-l articles">
        	<div class="media feel-info">
				<div class="media-left media-middle">
				    <a href="#">
				      <img class="media-object img-50" src="<?php echo ($system["admin_img"]); ?>" alt="<?php echo ($info["s_author"]); ?>" />
				    </a>
				</div>
				<div class="media-body feel-info-content">				    
				    <?php echo ($info["s_content"]); ?>				    
				</div>
				<div class="media-heading feel-info-title"><?php echo ($info["s_author"]); ?> 在<?php echo (getIp($info["s_ip"])); ?> 用  <a class="from"><?php echo ($info["s_from"]); ?></a> 发表</div>
			<hr />
        	</div>
            ...
            <div class="media-left">
                ...
                <div class="media-body">
                    ...
                    <p class="media-heading"><a><span class="glyphicon glyphicon-user"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["sc_name"]); ?>&nbsp;&nbsp;&nbsp;<a><span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($vo["sc_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a class="from"><?php echo ($vo["sc_from"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a><span class="glyphicon glyphicon-map-marker"></span></a>&nbsp;&nbsp;<?php echo ($vo["ip"]); ?></p>
                    <div class="connect-box"> <?php echo (reFace($vo["sc_content"])); ?></div>
                    <?php if(!empty($vo["sc_rtime"])): ?><hr class="content-hr" />
                    <div class="media">
                        <div class="media-left">
                        <a><img class="media-object img-circle img-50" src="<?php echo ($system["admin_img"]); ?>" alt="<?php echo ($vo["sc_rname"]); ?>"></a>
                        </div>
                        <div class="media-body">
                        <p class="media-heading"><a><span class="glyphicon glyphicon-king"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($vo["sc_rname"]); ?>&nbsp;&nbsp;&nbsp;<a><span class="glyphicon glyphicon-send"></span></a>&nbsp;<?php echo (date("m-d H:i",$vo["sc_rtime"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;回复&nbsp;<a>@<?php echo ($vo["sc_name"]); ?></a>&nbsp;中说到：</p>
            ...
            <div class="home-from">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="well">
                    <div method="post" >
					<input id="sid" type="hidden" value="<?php echo ($info["s_id"]); ?>" />
					<input id="stitle" type="hidden"  value="<?php echo (msubstr(strip_tags($info["s_content"]),0,40,'utf-8',ture)); ?>" />
					<input id="jump" type="hidden"  value="/feel-32.html" />
